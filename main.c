...
static void my_buttons_init(void)
{
    // Note: Array must be static because a pointer to it will be saved in the Button handler
    //       module.
    static app_button_cfg_t buttons[] =
    {
        {BTN_ON_OFF, APP_BUTTON_ACTIVE_LOW, BUTTON_PULL, my_button_event_handler},
        {BTN_MODE, APP_BUTTON_ACTIVE_LOW, BUTTON_PULL, my_button_event_handler},
				{BTN_INTENSITY_UP, APP_BUTTON_ACTIVE_LOW, BUTTON_PULL, my_button_event_handler},
				{BTN_INTENSITY_DOWN, APP_BUTTON_ACTIVE_LOW, BUTTON_PULL, my_button_event_handler}
    };
